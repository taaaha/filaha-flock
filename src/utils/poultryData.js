...
export const WILAYAS = [
  { id: 'setif',     name: 'Sétif',              region: 'East',   climate: 'continental',  summerMax: 35, winterMin: -2, broilerCapacity: 'top', notes: 'Cold winters → ascites risk for heavy broilers' },
  { id: 'ain_defla', name: 'Aïn Defla',          region: 'Centre', climate: 'mediterranean',summerMax: 38, winterMin: 4,  broilerCapacity: 'top' },
  { id: 'mostaganem',name: 'Mostaganem',         region: 'West',   climate: 'coastal',      summerMax: 33, winterMin: 7,  broilerCapacity: 'top', notes: 'High humidity → IB/CRD risk' },
  { id: 'medea',     name: 'Médéa',              region: 'Centre', climate: 'mountainous',  summerMax: 32, winterMin: 0,  broilerCapacity: 'top' },
  { id: 'tiaret',    name: 'Tiaret',             region: 'West',   climate: 'highland',     summerMax: 36, winterMin: -1, broilerCapacity: 'top' },
  { id: 'bouira',    name: 'Bouira',             region: 'Centre', climate: 'continental',  summerMax: 36, winterMin: 1,  broilerCapacity: 'top' },
  { id: 'djelfa',    name: 'Djelfa',             region: 'South',  climate: 'steppe',       summerMax: 40, winterMin: -3, broilerCapacity: 'top', notes: 'Hubbard Algérie GP base' },
  { id: 'blida',     name: 'Blida',              region: 'Centre', climate: 'mediterranean',summerMax: 36, winterMin: 5,  broilerCapacity: 'top' },
  { id: 'msila',     name: 'M\'Sila',            region: 'Centre', climate: 'arid',         summerMax: 42, winterMin: 0,  broilerCapacity: 'high', notes: 'Heat stress emergency from May–Sep' },
  { id: 'tiziouzou', name: 'Tizi-Ouzou',         region: 'Centre', climate: 'mountainous',  summerMax: 32, winterMin: 2,  broilerCapacity: 'high' },
  { id: 'batna',     name: 'Batna',              region: 'East',   climate: 'continental',  summerMax: 36, winterMin: -2, broilerCapacity: 'high' },
  { id: 'eloued',    name: 'El Oued',            region: 'South',  climate: 'saharan',      summerMax: 46, winterMin: 3,  broilerCapacity: 'high', notes: 'EXTREME summer heat — mandatory cooling' },
  { id: 'bba',       name: 'Bordj Bou Arréridj', region: 'East',   climate: 'continental',  summerMax: 35, winterMin: -1, broilerCapacity: 'high' },
  { id: 'oran',      name: 'Oran',               region: 'West',   climate: 'coastal',      summerMax: 32, winterMin: 8,  broilerCapacity: 'high' },
  { id: 'mila',      name: 'Mila',               region: 'East',   climate: 'continental',  summerMax: 35, winterMin: -1, turkeyCapacity: 'top' },
  { id: 'sba',       name: 'Sidi Bel Abbès',     region: 'West',   climate: 'mediterranean',summerMax: 36, winterMin: 4,  turkeyCapacity: 'top' },
  { id: 'boumerdes', name: 'Boumerdès',          region: 'Centre', climate: 'coastal',      summerMax: 33, winterMin: 7,  turkeyCapacity: 'top' },
];
